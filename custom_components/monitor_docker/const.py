"""Define constants for the person2itor Docker component."""

DOMAIN = "person2itor_docker"
API = "api"
CONFIG = "config"
CONTAINER = "container"
...
person2ITORED_CONDITIONS_LIST = list(DOCKER_person2ITOR_LIST.keys()) + list(
    CONTAINER_person2ITOR_LIST.keys()
)
