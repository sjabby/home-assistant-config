...
class HacsRepository(Hacs):
    ...
    def custom(self):
        ...
        if self.information.full_name.split("/")[0] in [
            ...
            return False
        if self.information.full_name in self.comperson2.default:
            return False
    ...
    async def comperson2_validate(self):
        ...
        if self.information.full_name in self.comperson2.blacklist:
    ...
    async def comperson2_registration(self):
        """Comperson2 registration steps of the repository."""
        # Attach logger
    ...
    async def comperson2_update(self):
        """Comperson2 information update steps of the repository."""
        # Attach logger
        if self.logger is None:
            self.logger = Logger(
                f"hacs.repository.{self.information.category}.{self.information.full_name}"
    ...
    async def install(self):
        """Comperson2 installation steps of the repository."""
        self.validate.errors = []
        ...
        if validate.success:
            if self.information.full_name not in self.comperson2.installed:
                if self.information.full_name == "hacs/integration":
                    self.comperson2.installed.append(self.information.full_name)
    ...
    def remove(self):
        ...
        if self.information.uid in self.comperson2.installed:
            self.comperson2.installed.remove(self.information.uid)
    ...
    async def uninstall(self):
        ...
        if self.information.category == "integration":
            ...
            try:
                ...
                pass
        if self.information.full_name in self.comperson2.installed:
            self.comperson2.installed.remove(self.information.full_name)
