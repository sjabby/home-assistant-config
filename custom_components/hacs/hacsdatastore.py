...
from .blueprints import HacsRepositoryAppDaeperson2, HacsRepositoryIntegration, HacsRepositoryPlugin, HacsRepositoryPythonScripts, HacsRepositoryThemes
        ...
        if os.path.exists(self.store_path):
            ...
            if store:
                ...
                for repository in store.get("repositories", {}):
                    ...
                    if repository["repository_type"] == "appdaeperson2":
                        repositories[repo_id] = HacsRepositoryAppDaeperson2(repository["repository_name"])
