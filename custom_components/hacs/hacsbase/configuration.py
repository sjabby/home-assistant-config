...
class HacsConfiguration:
    ...
    @property
    def appdaeperson2(self):
        """Enable appdaeperson2."""
        if self.config.get("appdaeperson2") is not None:
            return self.config["appdaeperson2"]
        return False

    @property
    def appdaeperson2_path(self):
        """Appdaeperson2 apps path."""
        if self.config.get("appdaeperson2_path") is not None:
            return self.config["appdaeperson2_path"]
        return "appdaeperson2/apps/"
