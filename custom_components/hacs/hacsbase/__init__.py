...
class HacsBase:
    ...
    async def register_new_repository(self, element_type, repo, repositoryobject=None):
        ...
        from ..repositories.hacsrepositoryappdaeperson2 import HacsRepositoryAppDaeperson2
        ...
        if element_type == "appdaeperson2":
            repository = HacsRepositoryAppDaeperson2(repo, repositoryobject)
    ...
    async def update_repositories(self, now=None):
        ...
        appdaeperson2, integrations, plugins, python_scripts, themes = (
            await self.get_repositories()
        )
