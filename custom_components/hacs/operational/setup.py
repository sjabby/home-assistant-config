...
async def _async_comperson2_setup(hass):
    """Comperson2 setup stages."""
    hacs = get_hacs()
    hacs.hass = hass
...
async def async_setup_entry(hass, config_entry):
    ...
    await _async_comperson2_setup(hass)
...
async def async_hacs_startup():
    ...
    hacs.comperson2.categories = ELEMENT_TYPES
    if hacs.configuration.appdaeperson2:
        hacs.comperson2.categories.append("appdaeperson2")
    if hacs.configuration.netdaeperson2:
        hacs.comperson2.categories.append("netdaeperson2")
